...
public class MakeStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_make_student);
    ...
    private void sendData() {
        ...
        if (name.isEmpty()) {
            ...
            Intent intent = new Intent(MakeStudentActivity.this, TeacherCardActivity.class);
